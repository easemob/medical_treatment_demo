	...
	<view class="page">
			...
			<view class="docdetail_head_body">
				<view class="headerbody_card">
					<view class="docdet-item-row">
						<image :src="detailData.avatar" class="docdet-item-avatar"></image>
						<view class="docdet-item-right">
							...
							<view class="docdet-item-docexpert">
								擅长：{{detailData.docexpert}}
							</view>
							<view class="docdet-item-bottom">
								<view class="docdet-item-cell">
									<text class="font-28">问诊量</text>
									<text class="docdet-item-text">{{detailData.docconsultation}}</text>
								</view>
								<view class="docdet-item-cell">
									<text class="font-28">平均回复时间</text>
									<text class="docdet-item-text">{{detailData.docresponse}}分钟</text>
								</view>
							</view>
						</view>
					</view>
		...
		<view class="flex align-center">
			<uni-list class="text-left" :border="false">
				<uni-list-item showArrow="true" showExtraIcon="true" clickable @click="openPicconsultation01">
				...
				<uni-list-item showArrow="true" showExtraIcon="true" clickable @click="openPicconsultation02">
					<view slot="body" class="slot-box">
						<view class="docdet-item__content">
				...
				<uni-list-item showArrow="true" showExtraIcon="true" clickable @click="openPicconsultation03">
					<view slot="body" class="slot-box">
						<view class="docdet-item__content">
	...
	export default {
		...
		methods: {
			...
			openPicconsultation01() {
				...
				uni.navigateTo({
					url: '../../consultation/picconsultation01?detailData=' + JSON.stringify(this.detailData)
				});
			},
			openPicconsultation02() {
				if (!store.state.hasLogin) {
					return uni.navigateTo({
						url: '../../login/login'
					});
				...
				uni.navigateTo({
					url: '../../consultation/picconsultation10?detailData=' + JSON.stringify(this.detailData) +
						'&ctype=2'
				});
			},
			openPicconsultation03() {
				if (!store.state.hasLogin) {
					return uni.navigateTo({
						url: '../../login/login'
					});
