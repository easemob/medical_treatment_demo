<template>
	...
	<cell>
		...
		<view :class="{ 'uni-list-item--disabled': disabled }"
			:hover-class="(!clickable && !link) || disabled || showSwitch || dishover? '' : 'uni-list-item--hover'"
			...
			<view class="uni-list-item__container"
				...
				<slot name="header">
					<view class="uni-list-item__header">
						<text v-if="leftText" class="uni-list-item__left-title">{{ leftText }}</text>
				...
				<slot name="footer">
					<view v-if="rightText || showBadge || showSwitch" class="uni-list-item__extra"
						...
						<text v-if="rightText" class="uni-list-item__extra-text"
							:class="rightColor === '' ? '':'text-'+rightColor">{{ rightText }}</text>
...
<script>
	 ...
	 * @property {String} 	rightColor 						右侧文字颜色
